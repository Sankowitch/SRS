...
$IPT -A FORWARD -i eth1 -o eth2 -m state --state NEW -j ACCEPT
...
# <--- Dodano 
#ovo prvo je vec ostvareno
$IPT -A FORWARD -i eth2 -p tcp -d 10.0.0.11 --dport 22 -m state --state NEW,ESTABLISHED -j ACCEPT
